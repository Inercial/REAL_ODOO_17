...
class PhysicalInventoryWithoutQty(models.TransientModel):
    _name = "physical.inventory.without.qty"
    _description = "Physical Inventory Without Quantity"


class ReportPhysicalInventoryWithoutQty(models.AbstractModel):
    _name = "report.real_reports.report_physical_inventory_without_qty"
    _description = "Report Physical Inventory Without Quantity"
...
ORDER BY
    product_name
        ...
        return {
            "doc_ids": docids,
            "doc_model": "physical.inventory.without.qty",
